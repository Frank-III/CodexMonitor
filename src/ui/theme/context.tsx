...
const STORAGE_KEYS = {
  THEME_ID: "codexmonitor-theme-id",
  COLOR_SCHEME: "codexmonitor-color-scheme",
  THEME_CSS_LIGHT: "codexmonitor-theme-css-light",
  THEME_CSS_DARK: "codexmonitor-theme-css-dark",
} as const

const THEME_STYLE_ID = "cm-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("cm-theme-preload")?.remove()
