      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative flex-1">
          <textarea
            ...
            class="h-10 max-h-60 min-h-10 w-full resize-none overflow-y-hidden border-none bg-transparent px-1 py-2 text-sm text-text-primary placeholder:text-text-subtle focus:outline-none"
            placeholder={
              props.disabled
...
function ComposerSelect(props: {
  ...
  return (
    <div class="flex w-max items-center gap-1 rounded-full bg-white/5 px-1.5 py-0.5">
      <span class="flex h-3.5 w-3.5 text-text-muted" aria-hidden>
        {props.icon}
      </span>
      <select
        class={`${props.width} min-w-0 cursor-pointer truncate border-none bg-transparent pr-3 text-[11px] text-text-muted focus:text-white focus:outline-none`}
        style={{
          ...
          "background-position": "calc(100% - 5px) calc(50% + 1px), calc(100% - 1px) calc(50% + 1px)",
